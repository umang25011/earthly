...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final firstNameField = TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.account_circle, color: ColorPallete.color3),
    ...
    final passwordField = TextFormField(
        ...
        textInputAction: TextInputAction.next,
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.vpn_key, color: ColorPallete.color3),
          contentPadding: EdgeInsets.fromLTRB(20, 15, 20, 15),
          hintText: "Password",
          hintStyle: TextStyle(color: ColorPallete.color3),
          border: OutlineInputBorder(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: ColorPallete.color3),
          onPressed: () {
  ...
  void signUp(String email, String password) async {
    if (_formKey.currentState.validate()) {
      ...
      Fluttertoast.showToast(msg: "Please Enter Proper Data");
    }
  }
