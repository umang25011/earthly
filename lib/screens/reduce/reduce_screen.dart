  ...
  List<Widget> getWidgetTree() {
        ...
        'options': [
          {
            ...
            'message':
                'Do not forget to switch off the lights or unplug your electronic devices when they are not in use',
          },
          {
            'icon': Icons.done_outline,
            'message':
                'Lower the amount of energy used to pump,treat and heat water by washing your car less often, using climate-appropriate plants in garden',
          },
          {
            'icon': Icons.do_not_disturb_alt,
            'message':
                'Don\'t set thermostat too high or low. Install a programmable model to turn off the heat or air conditioning when you\'re not at home',
          },
        ]
      },
      {
        ...
        'options': [
          {
            'icon': Icons.do_not_disturb_alt,
            'message':
                'Do not unnecessarily speed up or accelerate,it increases the mileage upto 33%, waste gas, money and increases carbon emission',
          },
          {
            'icon': Icons.done_outline,
            'message':
                'When possible,walk or ride your bike in order to avoid carbon emission completely',
          },
          {
            'icon': Icons.do_not_disturb_alt,
            'message':
                'Don\'t buy a minivan or SUV if you don\'t need 4WD and/or will ocassionally need extra space',
          },
        ]
      },
      {
    ...
    for (var reduceEmissionData in reduceCarbonFootPrintmsgs) {
      ...
      Widget cardHeader = ListTile(
        leading: Icon(
          reduceEmissionData['icon'] as IconData,
          color: ColorPallete.color3,
        ),
        title: CoolText(
          reduceEmissionData['title'].toString(),
          fontSize: 17,
        ),
      );
